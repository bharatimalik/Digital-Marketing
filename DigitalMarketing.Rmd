```{r}
rm(list = ls())
setwd("C:/Bharati/Digital Marketing")
...
mydata2 = read.csv("Amazon.csv", header = TRUE)
...
ggplot(df3, aes(x=facebookvisit, y=purchase, fill=facebookvisit)) + geom_boxplot() + 
